...
declare class Application {
   ...
   */
  readonly locale: KnownLocales | String
...
declare class GridRepeatConfig {
   ...
   */
  columnFlipType: RepeatGridShiftFlipType = RepeatGridShiftFlipType.NOSF;
   ...
   */
  patternType: Type = RepeatGridShiftFlipType.NOSF;
  
  /**
   * Row flip type of grid repeat art.
   */
  rowFlipType: Type = RepeatGridShiftFlipType.NOSF;
...
declare class SymmetryRepeatConfig {
   ...
   */
  axisRotationAngleInRadians: number = 1.57;
}
